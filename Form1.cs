    ...
    public partial class Form1 : Form
    {
        string[] zhuyin_list = new string[]
            { "ㄅ", "ㄉ", "ˇ", "ˋ", "ㄓ", "ˊ", "˙", "ㄚ", "ㄞ", "ㄢ", "ㄦ", "ㄆ", 
              ...
              "ㄙ", "ㄩ", "ㄝ", "ㄡ", "ㄥ", "ˉ" };
        Dictionary<string, string> zhuyin_pinyin_dict = new Dictionary<string, string> { 
            {"ㄅ", "b"}, {"ㄉ", "d"},  {"ㄓ", "zh"}, {"ㄚ", "a"},  {"ㄞ", "ai"}, {"ㄢ", "an"}, {"ㄦ", "er"},  {"ㄆ", "p"},
            {"ㄊ", "t"}, {"ㄍ", "g"},  {"ㄐ", "j"},  {"ㄔ", "ch"}, {"ㄗ", "z"},  {"ㄧ", "i"},  {"ㄛ", "o"},   {"ㄟ", "ei"}, {"ㄣ", "en"}, {"ㄇ", "m"}, {"ㄋ", "n"}, {"ㄎ", "k"},
            {"ㄑ", "q"}, {"ㄕ", "sh"}, {"ㄘ", "c"},  {"ㄨ", "u"},  {"ㄜ", "e"},  {"ㄠ", "ao"}, {"ㄤ", "ang"}, {"ㄈ", "f"},  {"ㄌ", "l"},  {"ㄏ", "h"}, {"ㄒ", "x"}, {"ㄖ", "r"}, 
            {"ㄙ", "s"}, {"ㄩ", "ü"},  {"ㄝ", "ê"},  {"ㄡ", "ou"}, {"ㄥ", "eng"},};
